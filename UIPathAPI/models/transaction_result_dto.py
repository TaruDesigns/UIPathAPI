...
class TransactionResultDto(object):
    ...
    def __init__(self, is_successful=None, processing_exception=None, defer_date=None, due_date=None, output=None, analytics=None, progress=None, _configuration=None):  # noqa: E501

...
class WrappedReleaseDto(object):
    ...
    def __init__(self, id=None, key=None, process_key=None, process_version=None, name=None, description=None, is_latest_version=None, environment_id=None, environment=None, input_arguments=None, _configuration=None):  # noqa: E501

...
class UserEntityDto(object):
    ...
    def __init__(self, full_name=None, authentication_source=None, user_name=None, is_inherited=None, assigned_to_folder_ids=None, may_have_attended=None, may_have_unattended=None, type=None, id=None, _configuration=None):  # noqa: E501

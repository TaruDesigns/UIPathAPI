...
class StartProcessDto(object):
    ...
    def source(self, source):
        ...
        :type: str
        """
        allowed_values = ["Manual", "Schedule", "Queue", "StudioWeb", "IntegrationTrigger", "StudioDesktop", "AutomationOpsPipelines", "Apps", "SAP", "HttpTrigger", "HttpTriggerWithCallback"]  # noqa: E501
        if (self._configuration.client_side_validation and

...
class JobDto(object):
    ...
    def source_type(self, source_type):
        ...
        :type: str
        """
        allowed_values = ["Manual", "Schedule", "Agent", "Queue", "StudioWeb", "IntegrationTrigger", "StudioDesktop", "AutomationOpsPipelines", "Apps"]  # noqa: E501
        if (self._configuration.client_side_validation and

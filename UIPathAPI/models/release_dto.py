...
class ReleaseDto(object):
    ...
    def __init__(self, key=None, process_key=None, process_version=None, is_latest_version=None, is_process_deleted=None, description=None, name=None, environment_id=None, environment_name=None, environment=None, entry_point_id=None, entry_point=None, input_arguments=None, process_type=None, supports_multiple_entry_points=None, requires_user_interaction=None, is_attended=None, is_compiled=None, automation_hub_idea_url=None, current_version=None, release_versions=None, arguments=None, process_settings=None, video_recording_settings=None, auto_update=None, feed_id=None, job_priority=None, specific_priority_value=None, organization_unit_id=None, organization_unit_fully_qualified_name=None, target_framework=None, robot_size=None, tags=None, remote_control_access=None, last_modification_time=None, last_modifier_user_id=None, creation_time=None, creator_user_id=None, id=None, _configuration=None):  # noqa: E501

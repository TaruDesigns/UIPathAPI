...
class TestSetExecutionOptionsDto(object):
    ...
    def __init__(self, batch_execution_key=None, trigger_type=None, test_cases=None, execute_only_specified_test_cases=None, robot_id=None, runtime_type=None, machine_id=None, machine_session_id=None, _configuration=None):  # noqa: E501

...
class AppTasksCreateRequest(object):
    ...
    def __init__(self, task_definition_id=None, task_definition_version=None, app_id=None, app_version=None, type=None, title=None, priority=None, data=None, task_catalog_name=None, external_tag=None, tags=None, _configuration=None):  # noqa: E501

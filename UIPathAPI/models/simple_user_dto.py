...
class SimpleUserDto(object):
    ...
    swagger_types = {
        ...
        'bypass_basic_auth_restriction': 'bool',
    ...
    attribute_map = {
        ...
        'bypass_basic_auth_restriction': 'BypassBasicAuthRestriction',
    ...
    def __init__(self, name=None, surname=None, user_name=None, domain=None, directory_identifier=None, full_name=None, email_address=None, is_email_confirmed=None, last_login_time=None, is_active=None, creation_time=None, authentication_source=None, password=None, is_external_licensed=None, user_roles=None, roles_list=None, login_providers=None, organization_units=None, tenant_id=None, tenancy_name=None, tenant_display_name=None, tenant_key=None, type=None, provision_type=None, license_type=None, robot_provision=None, unattended_robot=None, notification_subscription=None, key=None, may_have_user_session=None, may_have_robot_session=None, may_have_unattended_session=None, bypass_basic_auth_restriction=None, may_have_personal_workspace=None, update_policy=None, account_id=None, last_modification_time=None, last_modifier_user_id=None, creator_user_id=None, id=None, _configuration=None):  # noqa: E501
        ...
        self._bypass_basic_auth_restriction = None
        ...
        if bypass_basic_auth_restriction is not None:
            self.bypass_basic_auth_restriction = bypass_basic_auth_restriction
    ...
    @property
    def bypass_basic_auth_restriction(self):
        """Gets the bypass_basic_auth_restriction of this SimpleUserDto.  # noqa: E501

        DEPRECATED. Specifies whether this user bypasses the \"Auth.RestrictBasicAuthentication\" application setting (default: null)  # noqa: E501

        :return: The bypass_basic_auth_restriction of this SimpleUserDto.  # noqa: E501
        :rtype: bool
        """
        return self._bypass_basic_auth_restriction

    @bypass_basic_auth_restriction.setter
    def bypass_basic_auth_restriction(self, bypass_basic_auth_restriction):
        """Sets the bypass_basic_auth_restriction of this SimpleUserDto.

        DEPRECATED. Specifies whether this user bypasses the \"Auth.RestrictBasicAuthentication\" application setting (default: null)  # noqa: E501

        :param bypass_basic_auth_restriction: The bypass_basic_auth_restriction of this SimpleUserDto.  # noqa: E501
        :type: bool
        """

        self._bypass_basic_auth_restriction = bypass_basic_auth_restriction

...
class LogDto(object):
    ...
    def __init__(self, level=None, windows_identity=None, process_name=None, time_stamp=None, message=None, job_key=None, raw_message=None, robot_name=None, host_machine_name=None, machine_id=None, runtime_type=None, id=None, _configuration=None):  # noqa: E501

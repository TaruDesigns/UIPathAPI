...
class TransactionDataDto(object):
    ...
    def __init__(self, name=None, robot_identifier=None, specific_content=None, defer_date=None, due_date=None, reference=None, reference_filter_option=None, _configuration=None):  # noqa: E501

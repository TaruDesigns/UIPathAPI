...
class QueueItemDataDto(object):
    ...
    def __init__(self, name=None, priority=None, specific_content=None, defer_date=None, due_date=None, risk_sla_date=None, reference=None, progress=None, source=None, _configuration=None):  # noqa: E501

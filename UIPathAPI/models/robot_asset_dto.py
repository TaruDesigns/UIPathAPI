...
class RobotAssetDto(object):
    ...
    def __init__(self, name=None, value_type=None, string_value=None, bool_value=None, int_value=None, credential_username=None, credential_password=None, external_name=None, credential_store_id=None, key_value_list=None, id=None, _configuration=None):  # noqa: E501

...
class UserLoginAttemptsApi(object):
    ...
    def user_login_attempts_get_by_id(self, key, **kwargs):  # noqa: E501
        ...
        >>> thread = api.user_login_attempts_get_by_id(key, async_req=True)
        >>> result = thread.get()
        ...
        :return: ODataValueOfIEnumerableOfUserLoginAttemptDto
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_login_attempts_get_by_id_with_http_info(key, **kwargs)  # noqa: E501
        else:
            (data) = self.user_login_attempts_get_by_id_with_http_info(key, **kwargs)  # noqa: E501
            return data

    def user_login_attempts_get_by_id_with_http_info(self, key, **kwargs):  # noqa: E501
        """Gets the user's login attempts  # noqa: E501

        OAuth required scopes: OR.Users or OR.Users.Read.  Requires authentication. DEPRECATED:  This API is deprecated. Since we switched to access token authentication, user login attempts are no longer saved in Orchestrator. Only use it to retrieve historical data. Please refer to https://docs.uipath.com/orchestrator/reference  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_login_attempts_get_by_id_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method user_login_attempts_get_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('key' not in params or
            ...
            raise ValueError("Missing the required parameter `key` when calling `user_login_attempts_get_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/odata/UserLoginAttempts({key})', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ODataValueOfIEnumerableOfUserLoginAttemptDto',  # noqa: E501
